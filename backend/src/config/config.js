...
const config={
    ...
    GOOGLE_OAUTH_AUTHENTICATION_CLIENT_ID: process.env.GOOGLE_OAUTH_AUTHENTICATION_CLIENT_ID,
    GOOGLE_OAUTH_AUTHENTICATION_CLIENT_SECRET: process.env.GOOGLE_OAUTH_AUTHENTICATION_CLIENT_SECRET,
