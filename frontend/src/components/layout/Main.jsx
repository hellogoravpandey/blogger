  ...
  return (
            <div id="hero-container" className="max-w-4xl mx-auto px-6 pb-32 flex flex-col sm:items-center sm:text-center sm:pt-12" >
                ...
                <div id="button-container" className="mt-12 flex gap-4 flex-col sm:flex-row">
                    {isAuthenticated && (
                        <Link to="/create-blog" className="px-8 py-3 rounded-lg bg-primary text-white font-semibold shadow-sm hover:bg-opacity-90">
                            create blog
                        </Link>
                    )}
                    <a href="#latest-blogs" className="px-8 py-3 rounded-lg font-semibold border border-gray-400 hover:border-gray-800">
                        explore
                    </a>
                </div>
            </div> )
